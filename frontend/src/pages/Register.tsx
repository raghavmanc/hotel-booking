  ...
  return (
    <form className="flex flex-col gap-5" onSubmit={onSubmit}>
        ...
        <label className='text-gray-700 text-sm font-bold flex-1'>
            ...
            <label className='text-gray-700 text-sm font-bold flex-1'>
                Password
                <input type="password" className='border rounded w-full py-1 px-2 font-normal' {...register("password",{required: "This field is required", minLength: {value: 6, message:"Password must be 6 characters"}})}></input>
            ...
            <label className='text-gray-700 text-sm font-bold flex-1'>
                ...
                {validate:(val)=>{
                  ...
                  else if(watch('password') !== val){return "passwords do not match"}}})}></input>
